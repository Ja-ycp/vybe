...
<div class="comment-thread<?php echo $commentDepth > 0 ? ' comment-thread-reply' : ''; ?>" style="--comment-depth: <?php echo (int) min($commentDepth, 4); ?>;">
    <div class="comment-item">
        ...
        <div class="comment-main">
            ...
            <div class="comment-thread-actions">
                <form method="POST" action="<?php echo app_route('Comment', 'react', ['id' => $commentId]); ?>" data-comment-persist-panel>
    ...
    <form id="<?php echo app_e($replyFormId); ?>" method="POST" action="<?php echo app_route('Comment', 'create', ['id' => (int) $post['id']]); ?>" class="comment-form comment-composer comment-reply-form is-hidden" enctype="multipart/form-data" data-comment-composer data-comment-persist-panel>
        <input type="hidden" name="_token" value="<?php echo app_csrf_token(); ?>">
        <input type="hidden" name="redirect_to" value="<?php echo app_e($postRedirectTo); ?>">
