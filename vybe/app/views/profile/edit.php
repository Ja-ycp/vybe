        ...
        <section class="danger-panel" id="delete-account-card">
            ...
            >
                ...
                <div>
                    ...
                    <input type="text" name="delete_confirmation" id="deleteConfirmation" class="form-control form-control-lg danger-confirm-input" placeholder="CONFIRM DELETION" pattern="CONFIRM DELETION" required>
